...
<body>
	<header>
		<div class="header_menu">
			<nav class="nav1">
				<c:choose>
				<c:when test="${sessionScope.sessionVo == null}">
				<ul>
					<li><a href="http://localhost:9000/login">로그인</a></li>
					<li><a href="http://localhost:9000/join">회원가입</a></li>
					<!-- <li><a href="http://localhost:9000/mypage.do">마이페이지</a></li> -->
					<li><a href="#">VIP</a></li>
					<li><a href="#">고객센터</a></li>
					<li><a href="http://localhost:9000/notice/notice_list">공지사항</a></li>
					<li><a href="http://localhost:9000/board/board_list">게시판</a></li>
					<!-- <li><a href="http://localhost:9000/admin/admin_index.jsp" target="_parent">ADMIN</a></li> -->
				</ul>
				</c:when>
				<c:otherwise>
				<ul>
					<li><a href="#" style="width:150px">${sessionScope.sessionVo.name}님 반갑습니다</a></li>
			...
			<div>
				<a href="http://localhost:9000/" target="_parent">
