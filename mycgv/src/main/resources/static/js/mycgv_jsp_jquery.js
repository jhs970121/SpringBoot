			...
			$.ajax({
				...
				success : function(result) {
					if(result == 0){
						...
						.css("font-size","11px").css("display","block").css("padding","4px 0px");
						$("#pass").focus();
					}else {
						$("#idCheck_msg").text("이미 사용중인 아이디입니다. 다시 입력해주세요").css("color","tomato")
	...
	*******************************/
	$("#btnJoin").click(function(){
		...
		if($("#id").val() == ""){
			...
			alert("중복체크를 진행해주세요");
			$("#btnIdCheck").css("border","1px solid lightgray");
			return false;
		}else if($("#pass").val() == ""){
			alert("패스워드를 입력해주세요");
			$("#pass").focus();
